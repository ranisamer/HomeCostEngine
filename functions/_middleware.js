...
const TOPIC_BLOCKS = {
  roofing: `
    ...
    <p>Local climate and code matter too. Wind, snow, hail, wildfire exposure, coastal conditions and ventilation requirements can change the recommended assembly. Permit rules and inspection requirements vary by jurisdiction. Use the <a href="/calculators/roof-replacement">Roof Replacement Cost Calculator</a>, <a href="/calculators/roofing-square.html">Roofing Square Calculator</a> and <a href="/calculators/roof-pitch.html">Roof Pitch Calculator</a> as planning tools, then verify final details with a qualified local roofer. For independent industry information, review consumer resources from the <a href="https://www.nrca.net/roofing-guidelines/consumer-information" target="_blank" rel="noopener noreferrer">National Roofing Contractors Association</a>.</p>
  `,
  concrete: `
